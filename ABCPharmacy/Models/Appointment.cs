...
namespace ABCPharmacy.Models
{
    public class Appointment
    {
        ...
        public static int UpdateAppointment(Appointment appointment)
        {
            ...
            SqlCommand cmd = new SqlCommand("Update Appointments SET Indications=@Indications,Advice=@Advice, Symptoms=@Symptoms, Medications=@Medications,Comments=@Comments,Fees=@Fees  Where AppointmentId=@AppointmentId", con);

            //cmd.Parameters.Add(new SqlParameter("PatientId", PatientId));
            //cmd.Parameters.Add(new SqlParameter("DoctorId", DoctorId));
            //cmd.Parameters.Add(new SqlParameter("DOA", DOA));
            cmd.Parameters.Add(new SqlParameter("Symptoms", appointment.Symptoms));
